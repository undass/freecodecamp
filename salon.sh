...
#listing all services and displaying them
...
case $SERVICE_ID_SELECTED in
  [1-5]) NEXT ;;
    *) GET_SERVICE_ID "Service not found. What would you like today?" ;;
esac
...
NEXT() {
  ...
  then
    ...
    SAVED_TABLE_CUSTOMERS=$($PSQL "INSERT INTO customers(name,phone) VALUES('$NAME', '$CUSTOMER_PHONE')")
